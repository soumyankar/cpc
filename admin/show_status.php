...
<section>
  ...
  <center>
    <a class="btn btn-success filter" data-id="in progress">In Progress</a>
    <a class="btn btn-success filter" data-id="in admissible">In Admissible</a>
    <a class="btn btn-success filter" data-id="interim disposal">Interim Disposal</a>
    <a class="btn btn-success filter" data-id="pending">Pending</a>
    <a class="btn btn-success filter" data-id="solved">Solved</a>
  </center>
...
<script type="text/javascript">
  $('.filter').click(function() {
    ...
    // console.log(filter);
    $.post('status_filter.php',{filter:filter},function(data){
