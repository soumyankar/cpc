...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    ...
    <div class="navbar-header page-scroll">
      ...
      <a class="navbar-brand page-scroll" href="local_admin_page.php">Credit History</a>
    </div>
...
<section>
  ...
  <h2 class="aa_h2 container" align="center">All Uploads</h2>
              ...
              <tbody> 
                <?php
                    $sql2="Select * from add_credits where hash_id='$hash' ";
                      ...
                      if(!$found)
                      {
                        echo "<h4 style=\"position:absolute; top:60%; left:60%\">--No Uploads yet :(--</h4>";
                       }
                      else
                      {
